        ...
        <div class="wrap">
                ...
                <table class="widefat striped" style="max-width:700px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="color:<?php echo $entry['status'] === 'ok' ? 'green' : 'red'; ?>; font-weight:bold;">
            ...
            <table class="widefat" style="max-width:700px;">
                <tbody>
                    ...
                    <tr>
                        <td><strong><?php esc_html_e( 'URL', 'uptime-health-endpoint' ); ?></strong></td>
                        <td><code><?php echo esc_html( $endpoint . '?token=' . urlencode( $first_token ) ); ?></code></td>
                    </tr>
                    <tr>
                        <td><strong><?php esc_html_e( 'Expected Status', 'uptime-health-endpoint' ); ?></strong></td>
                        <td><code>200</code></td>
